"""Tests for rule extraction (src/rules.py)."""
...
class TestExtractRules:
    ...
    def test_extract_rules_calls_openai_with_correct_params(self, mock_openai_client, sample_section_data):
...
class TestValidateVerbatimRules:
    ...
    def test_validate_handles_multiple_rules(self):
        ...
        rules = [
            ...
            {
                "rule_text": "Civilians may not be attacked.",
                "rule_type": "prohibition"
            },
            {
