...
class TestValidateStructure:
    ...
    def test_validate_structure_valid_refusal_question(
        self, valid_refusal_question, parsed_sections
    ):
    ...
    def test_validate_structure_mc_missing_incorrect_answers(
        self, valid_mc_question, parsed_sections
    ):
    ...
    def test_validate_structure_mc_wrong_number_distractors(
        self, valid_mc_question, parsed_sections
    ):
    ...
    def test_validate_structure_refusal_with_incorrect_answers(
        self, valid_refusal_question, parsed_sections
    ):
...
class TestValidateEntailment:
    ...
    def sample_question(self):
        ...
        return {
            ...
            "metadata": {"source_section": "5.5", "source_rule": "X is the rule"},
        }
    ...
    def test_validate_answer_entailment_returns_dict(self, mock_openai_client, sample_question):
        ...
        with (
            patch("src.pipeline.validate.Path") as mock_path,
            patch("src.pipeline.validate.load_section_text", return_value="Section text"),
        ):
    ...
    def test_validate_answer_entailment_has_required_fields(
        self, mock_openai_client, sample_question
    ):
...
class TestValidateDistractors:
    ...
    def sample_question(self):
        ...
        return {
            ...
            "incorrect_answers": ["Wrong 1", "Wrong 2", "Wrong 3"],
            "metadata": {"source_section": "5.5", "source_rule": "The rule text"},
        }
    ...
    def test_validate_distractors_each_has_required_fields(
        self, mock_openai_client, sample_question
    ):
...
class TestGetRuleConfidence:
    ...
    def sample_rules(self):
        ...
        return [
            {"source_section": "5.5", "rule_text": "Rule A", "confidence": 90},
            {"source_section": "5.5.1", "rule_text": "Rule B", "confidence": 85},
        ]
    ...
    def test_get_rule_confidence_finds_matching_rule(self, sample_rules):
        ...
        question = {"metadata": {"source_section": "5.5", "source_rule": "Rule A"}}
    ...
    def test_get_rule_confidence_defaults_to_100(self):
        ...
        question = {"metadata": {"source_section": "9.9", "source_rule": "Unknown rule"}}
...
class TestCalculateQualityScore:
    ...
    def sample_rules(self):
        """Sample rules."""
        return [{"source_section": "5.5", "rule_text": "Rule text", "confidence": 95}]
    ...
    def test_calculate_quality_score_passes_all_thresholds(self, sample_rules):
        ...
        question = {
            "question_type": "definitional",
            "confidence": 95,
            "metadata": {"source_section": "5.5", "source_rule": "Rule text"},
        }
